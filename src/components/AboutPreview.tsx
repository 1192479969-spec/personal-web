    ...
    <section className="bg-gallery-white px-6 py-24 lg:px-10 lg:py-32">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div className="gallery-media-frame min-h-112 border border-gallery-line bg-gallery-black">
          <div className="flex h-full min-h-112 items-end bg-[radial-gradient(circle_at_30%_15%,rgba(138,111,61,0.28),transparent_30%),linear-gradient(145deg,#050505_0%,#262626_52%,#111111_100%)] text-gallery-white">
        ...
        <div className="lg:pl-8">
          ...
          <p className="mt-8 text-lg leading-9 text-gallery-soft">
            {aboutPreview.body}
          </p>
          <Link
