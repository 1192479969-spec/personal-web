    ...
    <main>
      <section className="mx-auto max-w-6xl px-6 py-20 lg:px-10 lg:py-28">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[minmax(max-content,1fr)_minmax(0,1fr)] lg:items-end">
          <div>
            <h1 className="-translate-y-38 whitespace-nowrap font-serif text-[clamp(2rem,7vw,3.5rem)] leading-tight tracking-[-0.03em] text-gallery-black">
              Yuanxin "Starr" Chen
            </h1>
            <p className="-translate-y-38 mt-5 text-sm uppercase tracking-gallery text-gallery-soft">
